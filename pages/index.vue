    ...
    <div>
        ...
        <section class="introduce2" id="introduce2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center container c">
                            <h3 style="" class="text-uppercase title">giải thưởng hấp dẫn</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 fix-bottom-parent">
                        <div class="fix-bottom">
                            ...
                            <div class="img-content">
                                <b>1 Giải nhì</b>
                                <p><b class="fee">14.000.000/người</b></p>
                ...
                <h5 style="color:#083e7c;margin-top:30px" class="text-uppercase title text-center">và hàng trăm giải thương hấp dẫn khác</h5>
            </div>
            <!-- <div>
        ...
        <section class="introduce3" id="introduce3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div>
                            <h3 class="text-uppercase title">cơ chế thi</h3>
                        </div>
                    </div>
                </div>
               <div class="row">
                   <div class="col-md-3">
                       <div class="item">
                           ...
                           <div class="content-block">
                               ...
                               <p>
                                   Các cá nhân và đội nhóm sẽ tham gia xây dựng lịch trình du lịch tự túc tại Hàn Quốc thông qua trang web của KTO. BTC sẽ lựa chọn 12 lịch trình xuất sắc nhất để tham gia vào vòng thi thứ 2,
                                   ngoài ra sẽ có 100 phần quà kỷ niệm dành cho các đội chơi may mắn khác.
                               </p>
                           </div>
                       </div>
                   </div>
                   <div class="col-md-3">
                       <div class="item">
                           ...
                           <div class="content-block">
                               ...
                               <p>
                                   12 cá nhân và/hoặc đội nhóm có lịch trình xuất sắc được lựa chọn từ vòng 1 sẽ thực hiện quay video trình bày ý tưởng về lịch trình đã xây dựng. BTC sẽ lựa chọn 2 lịch trình xuất sắc nhất và 2 lịch trình được yêu thích nhất để tham gia vòng 3,
                                   6 lịch trình còn lại sẽ nhận quả tặng từ Ban tổ chức
                               </p>
                           </div>
                       </div>
                   </div>
        ...
        <section class="introduce4" id="introduce4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 left-content">
                        <h3 class="text-uppercase title">Thể lệ vòng 1</h3>
                        <div>
                            <div>
                                <div class="sub-title">
                                    <b class="text-uppercase">bước 1:</b>
                                </div>
                                <div class="content">
                                    <p>
                                        Đăng nhập vào tài khoản KTO của bạn (hoặc đăng ký cực dễ dàng!)
                                    </p>
                                </div>
                            </div>
                            <div>
                                <div class="sub-title">
                                    <b class="text-uppercase" >bước 2:</b>
                                </div>
                                <div class="content">
                                    <p>
                                        Lựa chọn hình thức tham gia: Cá nhân hoặc theo Nhóm
                                    </p>
                                </div>
                            </div>
                            <div>
                                <div class="sub-title">
                                    <b  class="text-uppercase">bước 3:</b>
                                </div>
                                <div class="content">
                                    <p>
                                        Bắt đầu phần thi vòng 1 - Hãy xây dựng một lịch trình du lịch tự túc tại Hàn Quốc thật hợp lý và sáng tạo theo khung lịch trình mà KTO cung cấp, bạn nhé!
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="introduce6" id="introduce6">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div>
                            ...
                            <p>
                                ...
                                - BTC có quyền tạm dừng hoặc thay đổi nội dung, thể lệ chương trình vào bất kỳ thời điểm nào trước khi kết thúc chương trình mà không cần thông báo trước <br>
                                - Sau khi nhận giải nếu phát hiện gian lận, người nhận giải có trách nhiệm phải hoàn trả nguyên vẹn giải thưởng cho BTC, mọi chi phí phát sinh sẽ do người nhận giải chi trả<br>
                                - Giải thưởng không bao gồm các chi phí làm giấy tờ Visa, Hộ chiếu cho người thắng cuộc <br>
                                - Giải thưởng không có giá trị quy đổi ra tiền mặt hoặc hiện vật khác có giá trị tương đương <br>
